...
$_['heading_adding_recipient']				 = 'Додавання одержувача';
$_['heading_options_seat_calc']			     = 'Калькулятор місць відправлення';
$_['heading_components_list']				 = 'Вибір складових';
$_['heading_adding_to_registry']			 = 'Додавання у реєстр';
...
$_['button_options_seat_calc']				 = 'Калькулятор місць відправлення';
$_['button_components_list']				 = 'Список складових';
$_['button_delete_registry']				 = 'Видалити реєстр';
...
$_['column_calculation_base']           	 = 'База розрахунку';
$_['column_tariff_limit']           	     = 'Межа тарифу, грн';
$_['column_percent']           	             = 'Відсоток, %';
$_['column_fixed_amount']           	     = 'Фіксована сума, грн';
$_['column_minimum_payment']           	     = 'Мінімальний платіж, грн';
...
$_['column_sender_contact_person']           = 'Контактна особа відправника';
$_['column_sender_address']          		 = 'Адреса відправника';
$_['column_recipient']          			 = 'Одержувач';
$_['column_recipient_contact_person']        = 'Контактна особа отримувача';
...
$_['column_payment_control']         		 = 'Контроль оплати';
...
$_['entry_departments_filter_weight']		 = 'Фільтр відділень по вазі';
$_['entry_departments_filter_dimensions']	 = 'Фільтр відділень по габаритам';
$_['entry_department_types'] 				 = 'Тип відділень';
$_['entry_department_statuses'] 			 = 'Статус відділень';
...
$_['entry_poshtomat'] 						 = 'Поштомат';
$_['entry_settlement'] 					     = 'Населений пункт';
...
$_['entry_declared_cost_minimum']			 = 'Оголошена вартість мінімальна';
...
$_['entry_manual_processing']                = 'Ручна обробка';
$_['entry_avia_delivery']                    = 'Авіадоставка';
$_['entry_use_parameters']					 = 'Застосування параметрів';
$_['entry_weight'] 							 = 'Вага';
$_['entry_weight_minimum'] 					 = 'Вага мінімальна';
$_['entry_dimensions'] 						 = 'Розміри (Д x Ш x В)';
...
$_['entry_calculate_cod'] 				     = 'Врахування накладного платежу';
$_['entry_calculate_declared_cost_comm']     = 'Врахування комісії за оголошену вартість';
...
$_['entry_general_parameters']               = 'Загальні параметри';
$_['entry_length']              			 = 'Довжина';
$_['entry_width']              				 = 'Ширина';
$_['entry_height']          	    		 = 'Висота';
$_['entry_volume_weight'] 	             	 = 'Об`ємна вага';
$_['entry_weight_general']             		 = 'Загальна вага';
$_['entry_volume_general']              	 = 'Загальний об`єм';
$_['entry_volume_weight_general'] 	         = 'Загальна об`ємна вага';
...
$_['entry_create_date']					     = 'Дата створення';
$_['entry_registry'] 				         = 'Реєстр';
...
$_['help_departments_filter_weight']		 = 'Якщо увімкнути фільтр, то для клієнта список доступних відділень буде формуватися відповідно до загальної ваги товарів в кошику і максимально допустимою вагою для відділень';
$_['help_departments_filter_dimensions']	 = 'Якщо увімкнути фільтр, список доступних відділень для клієнта формуватиметься відповідно до розмірів відправлення, яке може прийняти кожне відділення';
$_['help_department_types']	 				 = 'Обраний тип відділень буде доступний для клієнтів під час оформлення замовлення. Якщо ви не вкажете жодного типу, то будуть доступні всі відділення';
$_['help_department_statuses'] 			     = 'Відділення з обраним статусом будуть доступні для клієнтів під час оформлення замовлення. Якщо ви не вкажете жодного типу, то будуть доступні всі відділення';
$_['help_discount'] 						 = 'Вкажіть знижку на доставку. Якщо у Вас немає знижки залиште поле порожнім';
$_['help_declared_cost_commission'] 		 = 'Вкажіть розмір комісії, яка розраховується як відсоток від оголошеної вартості відправлення';
...
$_['help_update_settlements']				 = 'Увімкнути/Вимкнути онлайн пошук населених пунктів для адресної доставки';
$_['help_update_streets']				     = 'Увімкнути/Вимкнути онлайн пошук вулиць для адресної доставки';
...
$_['help_sender_department'] 				 = 'Оберіть відділення з якого буде виконуватись відправка замовлення';
$_['help_sender_address'] 					 = 'Оберіть адресу з якої буде виконуватись відправка замовлення';
$_['help_sender_address_pick_up'] 			 = 'Чи потрібен забір посилки кур`єром?';
...
$_['help_recipient_city']              		 = 'Вкажіть макрос для міста та/або населеного пункту отримувача. Приклад: {shipping_city}';
...
$_['help_declared_cost_minimum']			 = 'Значення буде використано якщо оголошена вартість відправлення менше';
$_['help_departure_description']		 	 = 'Використовується як опис товару по замовчуванню при створенні «ЕН», якщо в магазині багато товарів, які мають однаковий опис. Можливе застосування макросів. При використанні макросів товару розділяйте текст на два блоки за допомогою символу «|» (макроси товару використовуйте в другому блоці)';
...
$_['help_general_parameters']                = 'Увімкнути/Вимкнути загальні параметри. Якщо загальні параметри вимкнені, то буде можливість встановити параметри для кожного місця відправлення при створенні ТТН';
$_['help_manual_processing']                 = 'Увімкнути/Вимкнути ручну обробку за замовчуванням. Використовуйте, якщо відправлення (місце) не упаковане в коробку або гофрокартон з плоским дном і не є плоским пакетом з одягом. Доставка тільки між вантажними відділеннями або на адресу';
$_['help_avia_delivery']                     = 'Увімкнути/Вимкнути авіадоставку за замовчуванням';
...
$_['help_weight_minimum'] 					 = 'Значення буде використано якщо вага відправлення менше';
...
$_['help_pack'] 							 = 'Увімкнути/Вимкнути врахування упаковки у вартості доставки';
$_['help_pack_type'] 						 = 'Вкажіть тип упаковки за замовчуванням';
$_['help_autodetection_pack_type']           = 'Увімкнути/Вимкнути автоматичний підбір упаковки з обраних типів. Якщо автовизначення не увімкнене, то буде використаний перший тип обраної упаковки';
...
$_['help_calculate_cod'] 				     = 'Увімкнути врахування комісії за накладений платіж у вартість доставки';
$_['help_calculate_declared_cost_comm']      = 'Увімкнути врахування комісії за оголошену вартість у вартість доставки';
...
$_['text_official_website']			         = 'Офіційний сайт Нова пошта';
$_['text_global']							 = 'Загальні';
$_['text_department']						 = 'Доставка у відділення';
...
$_['text_image_output_place_img_key'] 		 = 'В «img» способу доставки';
$_['text_parcel_tariffs'] 		             = 'Тарифи для посилок';
$_['text_cod_tariffs'] 		                 = 'Тарифи для накладеного платежа';
...
$_['text_enable_for_all_payment_methods'] 	 = 'Увімкнути для всіх способів оплати';
...
$_['text_recipient_success_add']			 = 'Отримувач успішно доданий';
...
$_['text_add']						         = 'Додати';
$_['text_add_to_registry']					 = 'Додати в реєстр';
$_['text_delete_from_registry']				 = 'Видалити з реєстру';
$_['text_success_added_to_registry']		 = 'Накладна успішно додана в реєстр';
$_['text_success_deleted_from_registry']	 = 'Накладна успішно видалена з реєстру';
$_['text_success_deleted_registry']	         = 'Реєстр успішно видалено';
...
$_['text_cn_a4']						     = 'ЕН А4';
$_['text_cn_a5']						     = 'ЕН А5';
$_['text_mark_85_85']						 = 'Маркування 85x85';
$_['text_mark_100_100']				         = 'Маркування 100x100';
$_['text_registry']							 = 'Реєстр';
$_['text_html']						         = 'HTML';
$_['text_pdf']						         = 'PDF';
...
$_['error_add_recipient'] 					 = 'Не вдалося додати отримувача!';
...
$_['error_added_to_registry']			     = 'Не вдалося додати накладну в реєстр!';
$_['error_deleted_from_registry']		     = 'Не вдалося видалити накладну з реєстру!';
$_['error_deleted_registry']		         = 'Не вдалося видалити реєстр!';
...
$_['error_recipient'] 						 = 'Отримувач не знайдений. Будь ласка, оберіть зі списку!';
$_['error_region'] 							 = 'Область не знайдена. Будь ласка, оберіть зі списку!';
$_['error_city'] 							 = 'Місто не знайдене. Будь ласка, оберіть зі списку!';
$_['error_settlement'] 						 = 'Населений пункт не знайдено. Будь ласка, оберіть зі списку!';
$_['error_department'] 					     = 'Відділення не знайдено. Будь ласка, оберіть зі списку!';
$_['error_address'] 				         = 'Адреса не знайдена. Будь ласка, оберіть зі списку!';
$_['error_street'] 						     = 'Вулиця не знайдена. Будь ласка, оберіть зі списку!';
...
$_['error_length']              			 = 'Довжина має бути цілим числом більше 0!';
$_['error_width']              				 = 'Ширина має бути цілим числом більше 0!';
$_['error_height']             		 		 = 'Висота має бути цілим числом більше 0!';
...
$_['error_departure_description'] 			 = 'Опис відправлення має бути від 3-х до 120-ти символів включно і мати сенс!';
