...
class ControllerExtensionModuleWDmegamenu extends Controller
{
    ...
    public function install() {
        ...
        $this->model_webdigify_wd_megamenu->createMenuTable();
    }

    public function uninstall() {
        $this->load->model('webdigify/wd_megamenu');

        $this->model_webdigify_wd_megamenu->deleteMenuData();
    }
    ...
    public function index() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
            if (!isset($this->request->get['module_id'])) {
                $this->model_setting_module->addModule('wd_megamenu', $this->request->post);
            } else {
        ...
        $data['menus'] = array();
        $menuList = $this->model_webdigify_wd_megamenu->getMenuList();
        ...
        if (!isset($this->request->get['module_id'])) {
            $data['breadcrumbs'][] = array(
                ...
                'href' => $this->url->link('extension/module/wd_megamenu', 'user_token=' . $this->session->data['user_token'], true)
            );
        } else {
            $data['breadcrumbs'][] = array(
                'text' => $this->language->get('heading_title'),
                'href' => $this->url->link('extension/module/wd_megamenu', 'user_token=' . $this->session->data['user_token'] . '&module_id=' . $this->request->get['module_id'], true)
            );
        }

        if (!isset($this->request->get['module_id'])) {
            $data['action'] = $this->url->link('extension/module/wd_megamenu', 'user_token=' . $this->session->data['user_token'], true);
        } else {
            $data['action'] = $this->url->link('extension/module/wd_megamenu', 'user_token=' . $this->session->data['user_token'] . '&module_id=' . $this->request->get['module_id'], true);
        }

        $data['menu_editor_link'] = $this->url->link('extension/module/wd_megamenu/menulist', 'user_token=' . $this->session->data['user_token'], true);
        ...
        $this->response->setOutput($this->load->view('extension/module/wd_megamenu', $data));
    }
    ...
    public function add() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
            $this->model_webdigify_wd_megamenu->addMenu($this->request->post);
            ...
            $this->response->redirect($this->url->link('extension/module/wd_megamenu/menuList', 'user_token=' . $this->session->data['user_token'] . $url, true));
        }
    ...
    public function edit() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
            ...
            $this->model_webdigify_wd_megamenu->editMenu($this->request->get['menu_id'], $this->request->post);
    ...
    public function delete() {
        ...
        if (isset($this->request->post['selected']) && $this->validateDelete()) {
            foreach ($this->request->post['selected'] as $menu_id) {
                $this->model_webdigify_wd_megamenu->deleteMenu($menu_id);
            }
    ...
    public function getlist() {
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('extension/module/wd_megamenu/menuList', 'user_token=' . $this->session->data['user_token'] . $url, true)
        );

        $data['add'] = $this->url->link('extension/module/wd_megamenu/add', 'user_token=' . $this->session->data['user_token'] . $url, true);
        $data['delete'] = $this->url->link('extension/module/wd_megamenu/delete', 'user_token=' . $this->session->data['user_token'] . $url, true);
        ...
        $menus_total = $this->model_webdigify_wd_megamenu->getMenuCount();

        $menus = $this->model_webdigify_wd_megamenu->getMenuList($filter_data);
        ...
        if($menus) {
            foreach ($menus as $menu) {
                $data['menu_list'][] = array(
                    ...
                    'url'       => $this->url->link('extension/module/wd_megamenu/edit', 'user_token=' . $this->session->data['user_token'] . '&menu_id=' . $menu['menu_id'] . $url, true)
                );
            }
        }
        ...
        $pagination->url = $this->url->link('extension/module/wd_megamenu/menuList', 'user_token=' . $this->session->data['user_token'] . $url . '&page={page}', true);
        ...
        $this->response->setOutput($this->load->view('extension/module/wd_megamenu/list', $data));
    }
    ...
    public function getForm() {
        ...
        if (!isset($this->request->get['menu_id'])) {
            $data['action'] = $this->url->link('extension/module/wd_megamenu/add', 'user_token=' . $this->session->data['user_token'] . $url, true);
        } else {
            $data['action'] = $this->url->link('extension/module/wd_megamenu/edit', 'user_token=' . $this->session->data['user_token'] . '&menu_id=' . $this->request->get['menu_id'] . $url, true);
        }

        if (!isset($this->request->get['menu_id'])) {
            $this->model_webdigify_wd_megamenu->deleteTopItemByMenu('0');
            $data['cancel'] = $this->url->link('extension/module/wd_megamenu/menuList', 'user_token=' . $this->session->data['user_token'] . $url, true);
        } else {
            $data['cancel'] = $this->url->link('extension/module/wd_megamenu/menuList', 'user_token=' . $this->session->data['user_token'] . $url, true);
        }

        if (isset($this->request->get['menu_id']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
            $menu_info = $this->model_webdigify_wd_megamenu->getMenu($this->request->get['menu_id']);
        }
        ...
        if (isset($this->request->get['menu_id'])) {
            ...
            foreach ($results as $result) {
                ...
                $data['top_items'][] = array(
                    ...
                    'url'           => $this->url->link('extension/module/wd_megamenu/editTopItem', 'user_token=' . $this->session->data['user_token'] . '&menu_item_id=' . $result['menu_item_id'] . '&menu_id=' . $this->request->get['menu_id'], true),
                    'del_url'       => $this->url->link('extension/module/wd_megamenu/deleteTopItem', 'user_token=' . $this->session->data['user_token'] . '&menu_item_id=' . $result['menu_item_id'] . '&menu_id=' . $this->request->get['menu_id'], true)
                );
            }
        }

        if (isset($this->request->get['menu_id'])) {
            $data['top_items_form_url'] = $this->url->link('extension/module/wd_megamenu/addTopItem', 'user_token=' . $this->session->data['user_token'] . '&menu_id=' . $this->request->get['menu_id'], true);
            $data['sub_item_add_form_url'] = $this->url->link('extension/module/wd_megamenu/addSubItem', 'user_token=' . $this->session->data['user_token'] . '&menu_id=' . $this->request->get['menu_id'], true);
            $data['sub_item_edit_form_url'] = $this->url->link('extension/module/wd_megamenu/editSubItem', 'user_token=' . $this->session->data['user_token'] . '&menu_id=' . $this->request->get['menu_id'], true);
            $data['multiple_del_url'] = $this->url->link('extension/module/wd_megamenu/deleteMultipleItems', 'user_token=' . $this->session->data['user_token'] . '&menu_id=' . $this->request->get['menu_id'], true);
        } else {
            $data['top_items_form_url'] = $this->url->link('extension/module/wd_megamenu/addTopItem', 'user_token=' . $this->session->data['user_token'], true);
            $data['sub_item_add_form_url'] = $this->url->link('extension/module/wd_megamenu/addSubItem', 'user_token=' . $this->session->data['user_token'], true);
            $data['sub_item_edit_form_url'] = $this->url->link('extension/module/wd_megamenu/editSubItem', 'user_token=' . $this->session->data['user_token'], true);
            $data['multiple_del_url'] = $this->url->link('extension/module/wd_megamenu/deleteMultipleItems', 'user_token=' . $this->session->data['user_token'], true);
        }

        $data['get_top_items_url'] = $this->url->link('extension/module/wd_megamenu/getTopItemsByAjax', 'user_token=' . $this->session->data['user_token'], true);

        if (!empty($_SERVER['HTTPS']) && $_SERVER['HTTPS'] != 'off') {
            $data['loader_image'] = HTTPS_CATALOG . 'image/catalog/demo/banners/ajax_loader.gif';
        } else {
        ...
        $this->response->setOutput($this->load->view('extension/module/wd_megamenu/form', $data));
    }
        ...
        if($results) {
            ...
            foreach ($results as $result) {
                ...
                if($sub_items_lv2) {
                    foreach ($sub_items_lv2 as $item) {
                        ...
                        $sub_items2[] = array(
                            ...
                            'name'      => $item['name'],
                            'position'  => $item['position'],
                            'url'           => $this->url->link('extension/module/wd_megamenu/editSubItem', 'user_token=' . $this->session->data['user_token'] . '&sub_menu_item_id=' . $item['sub_menu_item_id'] . '&menu_id=' . $menu_id, true),
                            'del_url'       => $this->url->link('extension/module/wd_megamenu/deleteSubItem', 'user_token=' . $this->session->data['user_token'] . '&sub_menu_item_id=' . $item['sub_menu_item_id'] . '&menu_id=' . $menu_id, true)
                        );
                    }
                }
                ...
                $json['top_items'][] = array(
                    ...
                    'name'          => $result['name'],
                    'position'      => $result['position'],
                    'url'           => $this->url->link('extension/module/wd_megamenu/editTopItem', 'user_token=' . $this->session->data['user_token'] . '&menu_item_id=' . $result['menu_item_id'] . '&menu_id=' . $menu_id, true),
                    'del_url'       => $this->url->link('extension/module/wd_megamenu/deleteTopItem', 'user_token=' . $this->session->data['user_token'] . '&menu_item_id=' . $result['menu_item_id'] . '&menu_id=' . $menu_id, true)
                );
            }
        }
    ...
    public function addTopItem() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateTopItemForm()) {
            ...
            $menu_top_item_id = $this->model_webdigify_wd_megamenu->addTopItem($post_data);
    ...
    public function editTopItem() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateTopItemForm()) {
            ...
            $this->model_webdigify_wd_megamenu->editTopItem($post_data, $this->request->get['menu_item_id']);
    ...
    public function deleteTopItem() {
        ...
        if (isset($this->request->get['menu_item_id'])) {
            $this->model_webdigify_wd_megamenu->deleteTopItem($this->request->get['menu_item_id']);
        ...
        if ($this->request->server['REQUEST_METHOD'] == 'POST') {
            ...
            if(isset($post_data['top_items'])) {
                ...
                foreach ($top_items as $top_item_id) {
                    $this->model_webdigify_wd_megamenu->deleteTopItem($top_item_id);
                }
            }
            ...
            if(isset($post_data['sub_items'])) {
                ...
                foreach ($sub_items as $sub_item_id) {
                    $this->model_webdigify_wd_megamenu->deleteSubItem($sub_item_id);
                }
            }
    ...
    public function getTopItemForm($menu_id) {
        ...
        if (isset($this->request->get['menu_item_id']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
            $menu_item_info = $this->model_webdigify_wd_megamenu->getTopItemById($this->request->get['menu_item_id']);
        }
        ...
        if(isset($this->request->get['menu_item_id'])) {
            $menu_item_description = $this->model_webdigify_wd_megamenu->getTopItemDescriptionById($this->request->get['menu_item_id']);
        } else {
        ...
        $categories = $this->model_webdigify_wd_megamenu->getTopCategories();
        ...
        $data['append_categories_link'] = $this->url->link('extension/module/wd_megamenu/appendChildCategories', 'user_token=' . $this->session->data['user_token'], true);
        ...
        if(!isset($this->request->get['menu_item_id'])) {
            $data['action'] = $this->url->link('extension/module/wd_megamenu/addTopItem', 'user_token=' . $this->session->data['user_token'] . '&menu_id=' . $menu_id, true);
        } else {
            $data['action'] = $this->url->link('extension/module/wd_megamenu/editTopItem', 'user_token=' . $this->session->data['user_token'] . '&menu_item_id=' . $this->request->get['menu_item_id'] . '&menu_id=' . $menu_id, true);
        }

        if(!$json) {
            $json['html'] = $this->load->view('extension/module/wd_megamenu/top_item_form', $data);
        }
    ...
    public function addSubItem() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateSubItemForm()) {
            ...
            $this->model_webdigify_wd_megamenu->addSubItem($post_data);
    ...
    public function editSubItem() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateSubItemForm()) {
            ...
            $this->model_webdigify_wd_megamenu->editSubItem($post_data, $this->request->get['sub_item_id']);
    ...
    public function deleteSubItem() {
        ...
        if (isset($this->request->get['sub_menu_item_id'])) {
            $this->model_webdigify_wd_megamenu->deleteSubItem($this->request->get['sub_menu_item_id']);
    ...
    public function getSubItemForm($menu_id) {
        ...
        if (isset($this->request->get['sub_item_id']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
            $sub_menu_item_info = $this->model_webdigify_wd_megamenu->getSubItemById($this->request->get['sub_item_id']);
        }
        ...
        if(isset($this->request->get['sub_item_id'])) {
            $menu_item_description = $this->model_webdigify_wd_megamenu->getSubItemDescriptionById($this->request->get['sub_item_id']);
        } else {
            $menu_item_description = array();
        }
        ...
        if(!isset($this->request->get['sub_item_id'])) {
            $data['action'] = $this->url->link('extension/module/wd_megamenu/addSubItem', 'user_token=' . $this->session->data['user_token'] . '&parent_id=' . $this->request->get['parent_id'] . '&level=' . $this->request->get['level'], true);
        } else {
            $data['action'] = $this->url->link('extension/module/wd_megamenu/editSubItem', 'user_token=' . $this->session->data['user_token'] . '&sub_item_id=' . $this->request->get['sub_item_id'], true);
        }

        if(!$json) {
            $json['html'] = $this->load->view('extension/module/wd_megamenu/sub_item_form', $data);
        }
    ...
    public function appendChildCategories() {
        ...
        $childCategories = $this->model_webdigify_wd_megamenu->getCategories($category_id);
    ...
    protected function validateTopItemForm() {
        if (!$this->user->hasPermission('modify', 'extension/module/wd_megamenu')) {
    ...
    public function autoCompleteCategory() {
        ...
        if (isset($this->request->get['filter_name'])) {
            ...
            $results = $this->model_webdigify_wd_megamenu->getAllCategories($filter_data);
