<?php
class ModelWebdigifyWDmegamenu extends Model
{
    public function createMenuTable() {
        ...
        $this->db->query("
			CREATE TABLE IF NOT EXISTS `" . DB_PREFIX . "megamenu_top_item` (
	            ...
	            `link` VARCHAR(255),
	            `icon` VARCHAR(255),
	            `sub_menu_type` VARCHAR(255),
	            `sub_menu_content_type` VARCHAR(255),
