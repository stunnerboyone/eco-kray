	...
	public function index() {
		...
		if(!$error){
			if (isset($this->request->get['filter_name'])) {
				...
				$image_width        = $this->config->get('module_wd_live_search_image_width') ? $this->config->get('module_wd_live_search_image_width') : 0;
				$image_height       = $this->config->get('module_wd_live_search_image_height') ? $this->config->get('module_wd_live_search_image_height') : 0;
				$title_length       = $this->config->get('module_wd_live_search_title_length');
				$description_length = $this->config->get('module_wd_live_search_description_length');
